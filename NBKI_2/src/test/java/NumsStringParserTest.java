...
public class NumsStringParserTest {
    ...
    @Test
    @DisplayName("Тест строки с целым числом.")
    public void testIntParse_1() {
        int i = 12345;
        assertEquals(i, NumsStringParser.getInt_1(intNum));
    }
    ...
    @Test
    @DisplayName("Тест строки с числом с плавающей запятой(число записано через . )")
    public void testDoubleParse_3() {
        double d = 12345.52;
        assertEquals(d, NumsStringParser.getDouble_1(doubleNum),0.00);
    }

    @Test
    @DisplayName("Тест строки с числом с плавающей запятой(число записано через , )")
    public void testDoubleParse_4() {
        double d = 12345.52;
        assertEquals(d, NumsStringParser.getDouble_1(doubleNumWithComma),0.00);
    }
}
